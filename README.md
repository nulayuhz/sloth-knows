...
The general idea behind this project is to consolidate public trading data from tradingview, finviz, marketwatch, etc in one place, and feed to chatGPT to draw some basic insights, such as resistence/support level, entry price, and identify potential chart patterns. It acts as a helper and/or "virtual analyst" to help beginners to gain bacis understanding of stock trading, and develop a trading sense.
...
- from 4:30PM EST to 9:30AM the next market open, there is 15 hours for ChatGPT to analyze the stocks, 300/15 = 20 stocks per hour, 60/20 = 3min per stock
